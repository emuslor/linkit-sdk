...
// The read action comming from master device.
...
// The write action comming from master device.
...
boolean LGATTService::begin(const LGATTUUID &uuid, int32_t index, int32_t timeout)
{
    ...
    // This is the register and profiles creation (adds service, characteristic and discriptor).
