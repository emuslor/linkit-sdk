...
typedef enum
{
    LGATT_STATUS_SUCCESS= 0, // Successful.
    LGATT_STATUS_FAILED = 1, // Failed.
}lgatt_os_status;
...
//   You can use this class to read and write Bluetooth GATT attributes and receive notifications.
...
public:
    ...
    // This function represents the destructor.
     
    virtual ~LGATTClient(){}

    // Description: This function initializes a Bluetooth 4.0 GATT Client.
    // Parameters
    ...
    // Parameters
    //    deviceAddress :  The Bluetooth 4.0 device address to connect.
    // Returns
    //    true:  Successful.
    //    false: Failed.
    // Example
    ...
    // Parameters
    //    enable :             If return is true, enable the notification; or disable the notification if return is false. 
    //    serviceUUID :        The UUID of the service provided by a Bluetooth 4.0 devices. 
    //    isPrimary :          Specifies if this service is primary. 
    ...
    // Parameters
    //     index :        The index of services. The maximum is the return value of getServiceCount(). 
    //     serviceUUID :  The UUID of the service provided by a Bluetooth 4.0 device. 
    //     isPrimary :    Indicates if this service is primary.
    // Returns
    //     true:  Successful.
    //     false: Failed.
    // Example
    ...
    // isPrimary :           Specifies if this service is primary. 
    // characteristicUUID :  The UUID of the characteristic. 
    // attrValue :           The attribute value, which is obtained from the remote Bluetooth 4.0 device if it's successful.
    // Returns
    //    true:  Successful.
    //    false: Failed.
    // Example
    ...
    //    isPrimary :           Specifies if this service is primary.
    //    characteristicUUID :  The UUID of the characteristic. 
    //    attrValue :           The attribute value, which is written to the remote Bluetooth 4.0 device if it's successful.
    // Returns
    //    true:  Successful.
    //    false: Failed.
    // Example
    ...
    // Parameters
    //    address :  The address of the remote device, which can be obtained during the scan. 
